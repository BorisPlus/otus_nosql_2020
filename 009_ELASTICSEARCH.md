...
___Вопрос___: Это было проделано с помощью Kibana, но "паттерн индекса" кроме как Kibana (или возможно Postman) нужен кому для осуществления какими-то суперзапросами, упрощающими жизнь разрабу или пр?
